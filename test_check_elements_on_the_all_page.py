...
from Web_services.Paid_lesoon_page.Сheck_all_elements_on_the_lesson_page.test_пользователь_авторизован_проверка_Header import ChecksAllElementsInLessonPageTheHeadersUserAuth
from Web_services.Paid_lesoon_page.Сheck_all_elements_on_the_lesson_page.test_пользователь_не_авторизован_проверка_Header import ChecksAllElementsInLessonPageTheHeadersUserNotAuth
from Web_services.Paid_lesoon_page.Сheck_all_elements_on_the_lesson_page.test_пользователь_не_авторизован_проверка_Body_вкладка_Видеоурок import ChecksAllElementsInLessonPageTheBodyTabVideoUserNotAuth
from Web_services.Paid_lesoon_page.Сheck_all_elements_on_the_lesson_page.test_пользователь_не_авторизован_проверка_Body_вкладка_Вопросы_к_уроку import ChecksAllElementsInLessonPageTheBodyTabQuestionsUserNotAuth
from Web_services.Paid_lesoon_page.Сheck_all_elements_on_the_lesson_page.test_пользователь_не_авторизован_проверка_Body_вкладка_Тесты import ChecksAllElementsInLessonPageTheBodyTabTestUserNotAuth
from Web_services.Paid_lesoon_page.Сheck_all_elements_on_the_lesson_page.test_пользователь_не_авторизован_проверка_Body_вкладка_Тренажеры import ChecksAllElementsInLessonPageTheBodyTabTrainersUserNotAuth
from Web_services.Paid_lesoon_page.Сheck_all_elements_on_the_lesson_page.test_проверка_наличия_элементов_в_Footer import ChecksAllElementsInLessonPageThePageInFooter
