...
class Test1(unittest.TestCase):
    ...
    def test_1(self):
        driver = self.driver
        driver.get("https://web-dev01.interneturok.ru/algebra/7-klass/glava-2-lineynaya-funktsiya/koordinatnaya-pryamaya/questions")
        ...
        driver.find_element_by_id("reg_user_email").send_keys("xzxxi2xlk@mail.ru")
