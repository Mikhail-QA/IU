...
class Test1Play(unittest.TestCase):
    def setUp(self):
    ...
    def test_1_play(self):
        ...
        driver.find_element_by_css_selector("div.video-blocker__play").click()
        ...
        driver.find_element_by_id("reg_user_email").send_keys("snx2basb2ajkl@mail.ru")
        ...
        try: self.assertTrue(self.is_element_present(By.CSS_SELECTOR, "div.popup__body-item"))
