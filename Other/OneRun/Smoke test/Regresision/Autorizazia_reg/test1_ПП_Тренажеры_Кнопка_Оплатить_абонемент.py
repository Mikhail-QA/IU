...
class Test1(unittest.TestCase):
    ...
    def test_1(self):
        driver = self.driver
        driver.get("https://web-dev01.interneturok.ru/algebra/7-klass/glava-2-lineynaya-funktsiya/koordinatnaya-pryamaya/trainers")
        driver.maximize_window()
        driver.find_element_by_css_selector(".blocker__button").click()
        ...
        driver.find_element_by_id("reg_user_email").send_keys("kss1xwoz2all21@mail.ru")
