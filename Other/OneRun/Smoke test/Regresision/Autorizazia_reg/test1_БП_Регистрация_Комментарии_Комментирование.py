...
class Test10(unittest.TestCase):
    ...
    def test_(self):
        ...
        driver.get(self.base_url + "/okruj-mir/4-klass/zemlya-i-chelovechestvo/mir-glazami-astronoma?seconds=0&chapter_id=1826")
        ...
        driver.find_element_by_id("reg_user_email").send_keys("poix2@mail.ru")
        ...
        self.assertEqual(u"Мир глазами астронома (окружающий мир 4 класс)", driver.title)
