...
class Test10(unittest.TestCase):
    ...
    def test_(self):
        ...
        driver.get(
            self.base_url + "/matematika/5-klass/drobnye-chisla/sravnenie-obyknovennyh-drobey?seconds=0&chapter_id=842")
        ...
        driver.find_element_by_id("reg_user_email").send_keys("po22222ix2@mail.ru")
        driver.find_element_by_css_selector(
            "#reg-form > div.dialog-form > div.dialog-form__control > #user_password").click()
        driver.find_element_by_css_selector(
        ...
        self.assertFalse(self.is_element_present(By.CSS_SELECTOR,
                                                 "#reg-form > div.dialog-form > div.dialog-form__control > div.dialog-form__control__warning"))
        self.assertEqual(u"Сравнение обыкновенных дробей", driver.title)
