...
class Twitter(unittest.TestCase):
    ...
    def test_Reg_Auth(self):
        ...
        driver.find_element_by_class_name("js-signin-email").send_keys("twitter.test.98@mail.ru")
        driver.find_element_by_css_selector("#login-dialog-dialog > div.LoginDialog-content.modal-content > div.LoginDialog-body.modal-body > div.LoginDialog-form > form > div.LoginForm-input.LoginForm-password > input").send_keys("Ponomarev1991")
        ...
        driver.find_element_by_css_selector("a.b-omniauth__item_icon_tw").click()
        # driver.find_element_by_id("accept").click()
        driver.save_screenshot('screen_TW.png')
        self.assertEqual(u"Регистрация", driver.find_element_by_css_selector("h3").text)
        self.assertEqual("Виктория грязь", driver.find_element_by_css_selector("p.b-oauth-user__name").text)
        self.assertEqual("twitter.test.98@mail.ru", driver.find_element_by_css_selector("p.b-oauth-user__email").text)
        ...
        try:
            self.assertEqual("twitter.test.98@mail.ru", driver.find_element_by_id("user_email").get_attribute("value"))
