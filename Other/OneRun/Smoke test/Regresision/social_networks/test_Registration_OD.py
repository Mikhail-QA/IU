...
class Odnoklassniki(unittest.TestCase):
    def setUp(self):
    ...
    def test_Reg_Auth(self):
        ...
        driver.find_element_by_id("field_email").send_keys("+79819949291")
        driver.find_element_by_id("field_password").send_keys("Testng1991")
        driver.find_element_by_css_selector("#loginContentBlock > form > div.form-actions > input").click()
        time.sleep(1)
        ...
        driver.find_element_by_css_selector("a.b-omniauth__item_icon_od").click()
        # driver.find_element_by_id("accept").click()
        driver.save_screenshot('screen_OD.png')
        self.assertEqual(u"Регистрация", driver.find_element_by_css_selector("h3").text)
        self.assertEqual("Виктор Челяба", driver.find_element_by_css_selector("p.b-oauth-user__name").text)
        self.assertEqual("false.try@mail.ru", driver.find_element_by_css_selector("p.b-oauth-user__email").text)
        ...
        try:
            self.assertEqual("false.try@mail.ru", driver.find_element_by_id("user_email").get_attribute("value"))
