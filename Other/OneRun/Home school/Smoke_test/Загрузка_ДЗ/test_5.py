...
class Student(unittest.TestCase):
    ...
    def test_deadline_is_not_limited(self):
        ...
        time.sleep(27)
        driver.get("https://web-dev01.interneturok.ru/school/lesson/15888/homework/57168")
        self.assertEqual(u"Срок сдачи ДЗ не ограничен",
