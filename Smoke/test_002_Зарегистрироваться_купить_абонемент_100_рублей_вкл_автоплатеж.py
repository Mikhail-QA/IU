...
@allure.story("Регистрируюсь, покупаю абонемент за 100 рублей с вкл автоплатежом")
class CreateAccountAndBuyTicket100YesAutoPayment(StartInterneturok):
    def test_buy_ticket_per_100_rubles(self):
        ...
        with allure.step("Вернулся в Мой профиль"):
            steps_in_profile.go_to_my_profile()
        with allure.step("Обновляю страницу"):
            driver.refresh()
        with allure.step("В виджете абонемент отображается купленный абонемент"):
