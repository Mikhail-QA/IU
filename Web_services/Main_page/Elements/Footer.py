...
class ChecksAllElementsThePageInFooter(StartInterneturokClassMethod):
    ...
    def test_text_apps_for_your_tablet_displayed_the_screen(self):
        with allure.test("В подвале сайта отображается текст (Приложения для планшета:)"):
    ...
    def test_icon_android_displayed(self):
        with allure.test("В подвале сайта в Приложения для планшета отображается иконка (Android)"):
            self.assertTrue(self.is_element_present(By.CSS_SELECTOR, "a.icon-android"))

    def test_icon_apple_displayed(self):
        with allure.test("В подвале сайта в Приложения для планшета отображается иконка (iOS)"):
            self.assertTrue(self.is_element_present(By.CSS_SELECTOR, "a.icon-ios"))

    def test_text_we_in_social_networks(self):
        with allure.test("В подвале сайта отображается текст (Мы в соцсетях:)"):
